...
$routes = [
    ...
    '/instructor/edit-course' => ['view', 'instructor/edit-course', true, 'instructor'],
    '/instructor/update-chapter' => [ModuleController::class, 'updateChapter', true, 'instructor'],
    '/instructor/update-quiz' => [QuizController::class, 'updateQuiz', true, 'instructor'],
    '/instructor/update-chapter-media' => [ModuleController::class, 'updateChapterMedia', true, 'instructor'],
